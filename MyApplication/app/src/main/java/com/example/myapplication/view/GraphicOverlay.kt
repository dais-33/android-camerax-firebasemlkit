...
class GraphicOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    companion object {
        ...
        abstract class Graphic(private val overlay: GraphicOverlay) {
            ...
            companion object {
                internal val RECT_COLOR = Color.RED
                internal val TEXT_COLOR = Color.YELLOW
                internal val TEXT_SIZE = 30.0f
                internal val STROKE_WIDTH = 2.0f
            }
             ...
             */
            fun translateX(x: Float): Float = if (overlay.facing == CameraCharacteristics.LENS_FACING_FRONT) {
    ...
    override fun getMatrix(): Matrix = _matrix
